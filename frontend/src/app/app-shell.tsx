...
import { Box, ChevronDown, Eye, Image, KeyRound, Languages, LayoutDashboard, LogOut, Menu, MessageSquareText, Monitor, Moon, MoreHorizontal, Settings, ShieldAlert, Sparkles, Sun, Users, Video } from "lucide-react";
...
const navigation = [
  ...
  { href: "/forbidden-probe-logs", label: "nav.forbiddenProbeLogs", icon: ShieldAlert },
