...
const ForbiddenProbeLogsPage = lazyNamed(() => import("@/features/accounts/forbidden-probe-logs-page"), "ForbiddenProbeLogsPage");
...
export function DeferredForbiddenProbeLogsPage() {
  return <DeferredPage page={ForbiddenProbeLogsPage} />;
}
