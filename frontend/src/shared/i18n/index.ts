  ...
  "zh-CN": {
    translation: {
      ...
      statusReauthRequired: "失效",
        ...
        forbiddenProbeDescription: "将对当前 Provider 下启用账号发起真实聊天请求。返回 403 的账号会标记为 403（24h 临时封禁）；探测可能消耗额度并耗时较长。",
        forbiddenProbeBatchTitle: "检测选中账号 403 状态？",
        forbiddenProbeBatchDescription: "将对选中的 {{count}} 个账号发起真实聊天探测。",
