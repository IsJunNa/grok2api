...
const resources = {
  "zh-CN": {
    translation: {
      ...
      forbiddenProbeLogs: {
        title: "403 日志",
        description: "后台 403 检测任务的运行历史。点检测后任务在后台执行，进度与明细在此查看。",
        search: "搜索任务 ID 或错误信息",
        provider: "来源",
        trigger: "触发方式",
        triggerManualAll: "手动全量",
        triggerManualBatch: "手动批量",
        ...
        allProviders: "全部来源",
        empty: "暂无 403 检测记录",
        detailTitle: "403 检测明细",
        detailDescription: "查看本次检测的汇总与每个账号结果。",
        backToList: "返回列表",
        cancelRun: "取消检测",
        canceled: "已取消 403 检测",
        itemSearch: "搜索账号名、ID 或详情",
        outcome: "结果",
        outcomeOk: "正常",
        ...
        detail: "详情",
        itemTime: "检测时间",
        itemsEmpty: "暂无账号明细（任务刚启动或尚未产生结果）",
        openAccount: "打开账号",
        markSuspended: "已临时封禁",
        markDisabled: "已永久停用",
        error: "错误",
      ...
      accounts: {
        ...
        buildAccountCount: "Grok Build 可调度",
        webAccountCount: "Grok Web 可调度",
        consoleAccountCount: "Grok Console 可调度",
        abnormalAccountCount: "异常账号数",
        routableAccountCount: "可调度账号 {{count}}",
        totalAccountCount: "总计 {{count}}",
      ...
      statusReauthRequired: "失效",
        statusCooldown: "冷却",
        statusForbidden: "403",
        statusForbiddenUntil: "403 临时封禁至 {{time}}，到期自动恢复",
        statusForbiddenDisabledHelp: "403 恢复后再失败，已永久停用",
        statusActive: "正常",
        botRisk: "风控",
        ...
        cleanupAction: "账号清理",
        forbiddenProbeAction: "403 检测",
        forbiddenProbeTitle: "检测全部账号 403 状态？",
        forbiddenProbeDescription: "将对当前 Provider 下启用账号发起真实聊天请求。返回 403 的账号会按 24h 临时封禁 / 二次永久停用策略标记。任务在后台执行，点开始后将跳转到 403 日志查看进度与明细；探测可能消耗额度并耗时较长。",
        forbiddenProbeBatchTitle: "检测选中账号 403 状态？",
        forbiddenProbeBatchDescription: "将对选中的 {{count}} 个账号发起真实聊天探测。任务在后台执行，点开始后将跳转到 403 日志查看进度与明细。",
        forbiddenProbeCompleted: "403 检测完成：探测 {{probed}}，正常 {{ok}}，403 {{forbidden}}，失败 {{failed}}，跳过 {{skipped}}",
        forbiddenProbeStarted: "403 检测已在后台启动，请到 403 日志查看进度",
        forbiddenProbeStart: "开始检测",
        importedProbeStarted: "导入完成，已自动启动 403 检测",
      ...
      settings: {
        ...
        accounts: {
          ...
          forbiddenProbeTitle: "403 检测",
          forbiddenProbeEnabled: "自动 403 检测",
          forbiddenProbeEnabledHelp: "按设定间隔对启用账号发起真实聊天探测；返回 403 时按下方复核策略临时封禁，累计达到次数后执行终态动作。",
          forbiddenProbeInterval: "检测间隔",
          forbiddenProbeIntervalHelp: "自动扫描间隔，支持 1 小时至 24 小时。",
          forbiddenProbeConcurrency: "检测并发",
          forbiddenProbeConcurrencyHelp: "同时探测的账号数；过高可能触发上游限流。",
          forbiddenProbeBatchSize: "单次扫描上限",
          forbiddenProbeBatchSizeHelp: "每次自动扫描最多检测的账号数。",
          forbiddenProbeSkipSuspended: "跳过已封禁账号",
          forbiddenProbeSkipSuspendedHelp: "跳过仍在 403 临时封禁窗口内的账号，节省探测配额。",
          forbiddenReviewCooldown: "复核等待时长",
          forbiddenReviewCooldownHelp: "每次 403 后临时封禁多久再允许复核（1–168 小时）。窗口内再次 403 不增加次数。",
          forbiddenReviewMaxHits: "累计 403 次数",
          forbiddenReviewMaxHitsHelp: "累计命中达到该次数后执行终态动作。例如 2 表示：第 1 次临时封禁，第 2 次执行终态。",
          forbiddenReviewFinalAction: "达到次数后动作",
          forbiddenReviewFinalActionHelp: "累计 403 达到上限后的处理：永久停用、标记需重授权，或直接删除账号。",
          forbiddenReviewFinalDisabled: "永久停用（403）",
          forbiddenReviewFinalReauth: "标记需重授权",
          forbiddenReviewFinalDelete: "删除账号",
        },
      ...
      apiErrors: {
        ...
        forbiddenProbeFailed: "403 检测失败",
        forbiddenProbeBusy: "已有 403 检测任务在运行，请稍后再试",
        forbiddenProbeJobNotFound: "403 检测任务不存在或已过期",
        forbiddenProbeLogListFailed: "读取 403 检测日志失败",
      },
    },
  },
  en: {
    translation: {
      ...
      nav: { dashboard: "Dashboard", accounts: "Accounts", forbiddenProbeLogs: "403 logs", models: "Models", clientKeys: "Client keys", creativeConsole: "Creative console", gallery: "Gallery", videoGallery: "Video Gallery", audits: "Request audits", docs: "Documentation", settings: "Settings" },
      forbiddenProbeLogs: {
        title: "403 logs",
        description: "Background 403 probe history. After starting a probe, watch progress and account details here.",
        search: "Search job ID or error",
        provider: "Provider",
        trigger: "Trigger",
        triggerManualAll: "Manual all",
        triggerManualBatch: "Manual batch",
        ...
        empty: "No 403 probe runs yet",
        detailTitle: "403 probe details",
        detailDescription: "Summary and per-account outcomes for this run.",
        backToList: "Back to list",
        cancelRun: "Cancel probe",
        canceled: "403 probe canceled",
        itemSearch: "Search account name, ID, or detail",
        outcome: "Outcome",
        outcomeOk: "OK",
        outcomeForbidden: "403",
        ...
        detail: "Detail",
        itemTime: "Probed at",
        itemsEmpty: "No account details yet (job just started or no results)",
        openAccount: "Open account",
        markSuspended: "Temporarily suspended",
        markDisabled: "Permanently disabled",
        error: "Error",
      },
      creativeConsole: {
      ...
      apiErrors: {
        ...
        forbiddenProbeFailed: "403 probe failed",
        forbiddenProbeBusy: "A 403 probe is already running. Try again later.",
        forbiddenProbeJobNotFound: "The 403 probe job was not found or has expired",
        forbiddenProbeLogListFailed: "Failed to load 403 probe logs",
      },
    },
  },
} as const;
